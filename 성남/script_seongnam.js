    ...
    sansung: [
        {
            ...
            review: "• 산성역 3번 출구 나가자마자 있는 초역세권 단지이다.<br>• 단지 안 평탄화가 잘 되어 있고 아이들이 매우 많은 것이 특징이다.<br>• 가운데 길을 사이로 단차가 존재하지만 설계를 통해 잘 극복한 모습이다.<br>• 24평 기준 다른 단지와 매매가가 1억 차이라면 무조건 평탄화가 잘 된 포레스티아를 선호한다.",
            top: "34.5%", left: "17.5%"
        },
        {
            name: "산성역 헤리스톤",
    ...
    sinheung: [
        {
            ...
            review: "• 성남 원도심에서 보기 드문 완전 평지 대단지이다.<br>• 인근 단지들 중 초등학교 배정과 역세권 접근성 면에서 가장 우위에 있다.",
            top: "57%", left: "70.5%"
        },
        {
            name: "중앙힐스테이트1차",
            detail: "연식 : 2012년<br>세대수 : 356세대<br>매매 : 8.7억(59㎡), 9.3억(84㎡)<br>전세 : 5.4억(59㎡), 5억(84㎡)<br>주차 : 569대(세대당 1.59대)<br>학군 : 성남제일초, 성남중앙초 (주소지에 따라 배정)",
            review: "• 단지 내에 4단계의 단차가 존재하며 분절이 심하다.<br>• 맨 뒷동에서 역으로 가려면 단지 내 엘리베이터를 최소 3번 타야 할 정도로 동선이 불편하다.<br>• 상가 1층이 지하 6층 높이일 정도로 지대 차이가 크며, 지하 주차장은 연결되어 있다.<br>• 거주 편의성 측면에서는 2단지 앞동을 가장 선호한다.",
            top: "78%", left: "77%"
        },
        {
    ...
    dandae: [
        {
            ...
            review: "• 단대오거리역과 가장 가까운 초역세권 단지이다.<br>• 대단지 프리미엄이 확실하며 커뮤니티 시설이 잘 갖춰져 있다.",
            top: "54%", left: "52%"
        },
        {
            name: "e편한세상금빛그랑메종2단지",
        ...
        },
        {
            ...
            review: "• 4, 6단지와 3단지, 금상초 사이의 길이 평탄화 되어있다. <br>• 1, 4, 6단지에서 북쪽으로 내려가면 대중교통과 상권을 이용할 수 있고 급경사를 피할 수 있다.",
            top: "39%", left: "76%"
        },
        {
            name: "e편한세상금빛그랑메종5단지",
        ...
        },
        {
            ...
            review: "• 엘리베이터를 타고 단지 내부로 진입하는 구조이다.<br>• 단지 내에 약간의 경사가 있긴 하지만 도보로 이동 가능한 수준이다.<br>• 단지 내 차가 다니지 않아 매우 조용하고 쾌적한 특징이 있다.",
            top: "59.5%", left: "38%"
        },
        {
            name: "황송마을",
    ...
    areaData[areaId].forEach(apt => {
        ...
        marker.addEventListener('pointerup', (e) => {
            ...
            if (distance < 10) {
                ...
                setTimeout(() => showInfo(apt.name, apt.detail, apt.review), 10);
            }
        });
...
function showInfo(name, detail, review) {
	...
	if (review == "") {
		...
		document.getElementById('aptReview').innerHTML = review; // 후기 데이터 매핑
	}
